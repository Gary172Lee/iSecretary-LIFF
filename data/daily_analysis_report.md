...
> 報告狀態：**完成**｜產生時間：2026-09-22 14:25:29（Asia/Taipei）
...
- 產生時間：2026-09-22 14:25:29（Asia/Taipei）
- latest_indicators：2026-09-22 14:25:11
- gate_diagnostics：2026-09-22 14:25:21
- 資料為今日：是
- 策略與引擎版本相容：是
...
- 今日候選池：19；Buy Now：0；Wait Pullback：18；Reject：1。
**今日 Buy Now = 0 檔。寧可沒有標的，也不把已過度延伸的強勢股當成現在可追價。**
**Wait Pullback（股票可強，但現價不是好買點；不列正式買進）**
- 2885 元大金｜**Wait Pullback**：現價進場優勢 77.90；剩餘空間 10.0%；Forward RR 2.58；Pullback參考 69.95；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 2834 臺企銀｜**Wait Pullback**：現價進場優勢 72.09；剩餘空間 10.0%；Forward RR 2.32；Pullback參考 17.85；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 2887 台新金｜**Wait Pullback**：現價進場優勢 71.27；剩餘空間 10.0%；Forward RR 2.75；Pullback參考 42.75；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 2884 玉山金｜**Wait Pullback**：現價進場優勢 63.19；剩餘空間 10.0%；Forward RR 1.86；Pullback參考 45.30；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 2881 富邦金｜**Wait Pullback**：現價進場優勢 60.85；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 未載明；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3017 奇鋐｜**Wait Pullback**：現價進場優勢 60.38；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 3347.50；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 2883 開發金｜**Wait Pullback**：現價進場優勢 59.50；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 38.40；原因：entry_quality_below_7、forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 2892 第一金｜**Wait Pullback**：現價進場優勢 59.00；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 38.90；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3532 台勝科｜**Wait Pullback**：現價進場優勢 57.96；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 433.75；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3044 健鼎｜**Wait Pullback**：現價進場優勢 56.57；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 513.50；原因：entry_quality_below_7、forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
...
- **6182 合晶｜Deep Recovery 3M**：現價 119.00；3M最高收盤 189.50；距高點 -37.2%；回前高空間 +59.2%；自低點回升 +40.5%；Recovery StrongUp；延伸動能 91.0／Strong；RS改善 3.4；量能 1.36x；候選分 87.30／RecoveryLeading；題材 `semiconductor`；基本面/消息面：待ChatGPT排程即時健康審核。
- **6488 環球晶｜Deep Recovery 3M**：現價 971.00；3M最高收盤 1515.00；距高點 -35.9%；回前高空間 +56.0%；自低點回升 +24.8%；Recovery WeakUp；延伸動能 70.0／Moderate；RS改善 8.0；量能 1.30x；候選分 70.50／RecoveryReady；題材 `semiconductor`；基本面/消息面：待ChatGPT排程即時健康審核。
- **5425 台半｜Deep Recovery 3M**：現價 93.50；3M最高收盤 144.00；距高點 -35.1%；回前高空間 +54.0%；自低點回升 +39.1%；Recovery ModerateUp；延伸動能 63.0／Moderate；RS改善 -1.0；量能 0.80x；候選分 64.40／RecoveryEmerging；題材 `semiconductor`；基本面/消息面：待ChatGPT排程即時健康審核。
...
- 新假設候選：0
- 主要排除原因：
  - Tradeable Second Leg path 未通過：做多方向一致：32檔
  - Tradeable Second Leg path 未通過：型態與分數品質：32檔
  - Tradeable Second Leg path 未通過：目標報酬至少 10%：32檔
...
- Performance完成樣本：605；正式Direct Buy完成樣本：0。
- 被拒絕候選整體勝率：50.08%；T+5平均報酬：0.38%；MFE：5.08%；MAE：-4.54%。
