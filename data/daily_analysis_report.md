...
> 報告狀態：**完成**｜產生時間：2026-09-21 14:25:45（Asia/Taipei）

## 1. 今日結論

**今日無可直接買進標的。**
Raw候選 49 檔；舊路徑退役觀察 0 檔；新假設v2.1預先登記觀察 0 檔。
Full Validation已由使用者暫緩，不會自動執行，也不會耗用七年驗證的Actions額度。
Swing Buy 20D：23 檔合格；依 Extension Momentum 作第二層排序，v4.0 Gate 不變。
Swing Buy 20D：候選池 23；正式 Buy Now 0。正式名單以現價 Forward Entry Edge 為準。
Deep Recovery 3M：3 檔候選；屬早期復甦觀察池，不是BuyNow。

## 2. 資料日期、版本、工具讀取結果、P0安全與歷史來源稽核

- 報告版本：`daily_after_market_report_v5_deep_recovery_3m`
- 產生時間：2026-09-21 14:25:45（Asia/Taipei）
- latest_indicators：2026-09-21 14:25:26
- gate_diagnostics：2026-09-21 14:25:35
- 資料為今日：是
- 策略與引擎版本相容：是
...
- 今日候選池：23；Buy Now：0；Wait Pullback：19；Reject：4。
**今日 Buy Now = 0 檔。寧可沒有標的，也不把已過度延伸的強勢股當成現在可追價。**
**Wait Pullback（股票可強，但現價不是好買點；不列正式買進）**
- 2885 元大金｜**Wait Pullback**：現價進場優勢 73.79；剩餘空間 10.0%；Forward RR 2.77；Pullback參考 69.55；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 2881 富邦金｜**Wait Pullback**：現價進場優勢 62.15；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 未載明；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 1303 南亞｜**Wait Pullback**：現價進場優勢 61.70；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 231.75；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3017 奇鋐｜**Wait Pullback**：現價進場優勢 61.38；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 3347.50；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 2834 臺企銀｜**Wait Pullback**：現價進場優勢 60.72；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 17.82；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3044 健鼎｜**Wait Pullback**：現價進場優勢 59.60；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 502.50；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 2376 技嘉｜**Wait Pullback**：現價進場優勢 58.43；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 358.50；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3532 台勝科｜**Wait Pullback**：現價進場優勢 57.63；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 429.50；原因：entry_quality_below_7、forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3374 精材｜**Wait Pullback**：現價進場優勢 57.25；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 449.50；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 2891 中信金｜**Wait Pullback**：現價進場優勢 56.94；剩餘空間 9.2%；Forward RR 1.37；Pullback參考 69.00；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
...
- **6182 合晶｜Deep Recovery 3M**：現價 115.00；3M最高收盤 189.50；距高點 -39.3%；回前高空間 +64.8%；自低點回升 +35.8%；Recovery ModerateUp；延伸動能 85.0／Strong；RS改善 9.1；量能 1.15x；候選分 84.50／RecoveryLeading；題材 `semiconductor`；基本面/消息面：待ChatGPT排程即時健康審核。
- **5483 中美晶｜Deep Recovery 3M**：現價 186.50；3M最高收盤 278.00；距高點 -32.9%；回前高空間 +49.1%；自低點回升 +22.3%；Recovery ModerateUp；延伸動能 76.0／Strong；RS改善 5.5；量能 1.16x；候選分 77.80／RecoveryReady；題材 `semiconductor`；基本面/消息面：待ChatGPT排程即時健康審核。
- **5425 台半｜Deep Recovery 3M**：現價 93.30；3M最高收盤 144.00；距高點 -35.2%；回前高空間 +54.3%；自低點回升 +38.8%；Recovery ModerateUp；延伸動能 61.0／Moderate；RS改善 -2.3；量能 0.88x；候選分 63.80／RecoveryEmerging；題材 `semiconductor`；基本面/消息面：待ChatGPT排程即時健康審核。
...
- Performance完成樣本：591；正式Direct Buy完成樣本：0。
- 被拒絕候選整體勝率：49.58%；T+5平均報酬：0.31%；MFE：5.04%；MAE：-4.63%。
