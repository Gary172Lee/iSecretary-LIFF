...
> 報告狀態：**完成**｜產生時間：2026-09-17 14:26:40（Asia/Taipei）

## 1. 今日結論

**今日無可直接買進標的。**
Raw候選 54 檔；舊路徑退役觀察 0 檔；新假設v2.1預先登記觀察 0 檔。
Full Validation已由使用者暫緩，不會自動執行，也不會耗用七年驗證的Actions額度。
Swing Buy 20D：28 檔合格；依 Extension Momentum 作第二層排序，v4.0 Gate 不變。
Swing Buy 20D：候選池 28；正式 Buy Now 0。正式名單以現價 Forward Entry Edge 為準。
Deep Recovery 3M：1 檔候選；屬早期復甦觀察池，不是BuyNow。

## 2. 資料日期、版本、工具讀取結果、P0安全與歷史來源稽核

- 報告版本：`daily_after_market_report_v5_deep_recovery_3m`
- 產生時間：2026-09-17 14:26:40（Asia/Taipei）
- latest_indicators：2026-09-17 14:26:22
- gate_diagnostics：2026-09-17 14:26:31
- 資料為今日：是
- 策略與引擎版本相容：是
...
- 今日候選池：28；Buy Now：0；Wait Pullback：22；Reject：6。
**今日 Buy Now = 0 檔。寧可沒有標的，也不把已過度延伸的強勢股當成現在可追價。**
**Wait Pullback（股票可強，但現價不是好買點；不列正式買進）**
- 2881 富邦金｜**Wait Pullback**：現價進場優勢 72.89；剩餘空間 10.0%；Forward RR 1.84；Pullback參考 149.00；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 2886 兆豐金｜**Wait Pullback**：現價進場優勢 71.33；剩餘空間 10.0%；Forward RR 1.82；Pullback參考 50.48；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 2382 廣達｜**Wait Pullback**：現價進場優勢 71.05；剩餘空間 10.0%；Forward RR 1.95；Pullback參考 339.75；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 5880 合庫金｜**Wait Pullback**：現價進場優勢 67.47；剩餘空間 10.0%；Forward RR 1.86；Pullback參考 26.55；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 1326 台化｜**Wait Pullback**：現價進場優勢 59.42；剩餘空間 10.0%；Forward RR 1.70；Pullback參考 71.55；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 2890 永豐金｜**Wait Pullback**：現價進場優勢 59.05；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 43.62；原因：entry_quality_below_7、forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 2615 萬海｜**Wait Pullback**：現價進場優勢 58.90；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 未載明；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 1301 台塑｜**Wait Pullback**：現價進場優勢 58.64；剩餘空間 10.0%；Forward RR 1.74；Pullback參考 66.20；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3374 精材｜**Wait Pullback**：現價進場優勢 57.17；剩餘空間 10.0%；Forward RR 1.53；Pullback參考 444.50；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 2884 玉山金｜**Wait Pullback**：現價進場優勢 56.23；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 43.35；原因：entry_quality_below_7、forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
...
- **5425 台半｜Deep Recovery 3M**：現價 92.60；3M最高收盤 144.00；距高點 -35.7%；回前高空間 +55.5%；自低點回升 +37.8%；Recovery WeakUp；延伸動能 66.0／Moderate；RS改善 5.6；量能 0.93x；候選分 65.80／RecoveryEmerging；題材 `semiconductor`；基本面/消息面：待ChatGPT排程即時健康審核。
...
- 主要排除原因：
  ...
  - Tradeable Second Leg path 未通過：型態與分數品質：21檔
  - Tradeable Second Leg path 未通過：合法突破情境：21檔
  - Tradeable Second Leg path 未通過：突破跟隨：21檔
  - Tradeable Second Leg path 未通過：對手方被困：21檔
  - Tradeable Second Leg path 未通過：True Breakout 品質：21檔
  - Tradeable Second Leg path 未通過：可交易第二段：21檔
  - Tradeable Second Leg path 未通過：進場確認：18檔
- Candidate Stage：
...
- Performance完成樣本：561；正式Direct Buy完成樣本：0。
- 被拒絕候選整體勝率：48.66%；T+5平均報酬：0.19%；MFE：5.05%；MAE：-4.73%。
