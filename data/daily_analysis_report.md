...
> 報告狀態：**完成**｜產生時間：2026-09-23 14:25:18（Asia/Taipei）

## 1. 今日結論

**今日無可直接買進標的。**
Raw候選 57 檔；舊路徑退役觀察 0 檔；新假設v2.1預先登記觀察 0 檔。
...
- 產生時間：2026-09-23 14:25:18（Asia/Taipei）
- latest_indicators：2026-09-23 14:24:58
- gate_diagnostics：2026-09-23 14:25:09
- 資料為今日：是
- 策略與引擎版本相容：是
...
- 今日候選池：22；Buy Now：0；Wait Pullback：18；Reject：4。
**今日 Buy Now = 0 檔。寧可沒有標的，也不把已過度延伸的強勢股當成現在可追價。**
**Wait Pullback（股票可強，但現價不是好買點；不列正式買進）**
- 2885 元大金｜**Wait Pullback**：現價進場優勢 78.31；剩餘空間 10.0%；Forward RR 4.00；Pullback參考 69.95；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 2884 玉山金｜**Wait Pullback**：現價進場優勢 75.12；剩餘空間 10.0%；Forward RR 3.00；Pullback參考 45.38；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 2887 台新金｜**Wait Pullback**：現價進場優勢 73.22；剩餘空間 10.0%；Forward RR 2.67；Pullback參考 42.88；原因：forward_entry_edge_score_below_80、traceable_headroom_below_12pct。
- 2881 富邦金｜**Wait Pullback**：現價進場優勢 64.25；剩餘空間 10.0%；Forward RR 1.57；Pullback參考 未載明；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3017 奇鋐｜**Wait Pullback**：現價進場優勢 59.11；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 3345.00；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3105 穩懋｜**Wait Pullback**：現價進場優勢 57.01；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 469.00；原因：entry_quality_below_7、forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3044 健鼎｜**Wait Pullback**：現價進場優勢 56.75；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 514.50；原因：entry_quality_below_7、forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 3532 台勝科｜**Wait Pullback**：現價進場優勢 56.47；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 435.50；原因：entry_quality_below_7、forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 2883 開發金｜**Wait Pullback**：現價進場優勢 55.20；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 38.40；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 2317 鴻海｜**Wait Pullback**：現價進場優勢 49.74；剩餘空間 6.0%；Forward RR 1.33；Pullback參考 250.25；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
...
- **6182 合晶｜Deep Recovery 3M**：現價 115.50；3M最高收盤 189.50；距高點 -39.1%；回前高空間 +64.1%；自低點回升 +36.4%；Recovery ModerateUp；延伸動能 73.0／Moderate；RS改善 -4.0；量能 1.54x；候選分 75.90／RecoveryReady；題材 `semiconductor`；基本面/消息面：待ChatGPT排程即時健康審核。
- **5425 台半｜Deep Recovery 3M**：現價 95.70；3M最高收盤 144.00；距高點 -33.5%；回前高空間 +50.5%；自低點回升 +42.4%；Recovery ModerateUp；延伸動能 66.0／Moderate；RS改善 2.7；量能 0.76x；候選分 72.80／RecoveryReady；題材 `semiconductor`；基本面/消息面：待ChatGPT排程即時健康審核。
- **6488 環球晶｜Deep Recovery 3M**：現價 950.00；3M最高收盤 1515.00；距高點 -37.3%；回前高空間 +59.5%；自低點回升 +22.1%；Recovery WeakUp；延伸動能 62.0／Moderate；RS改善 2.1；量能 1.62x；候選分 67.10／RecoveryEmerging；題材 `semiconductor`；基本面/消息面：待ChatGPT排程即時健康審核。
...
- 新假設候選：0
- 主要排除原因：
  - Tradeable Second Leg path 未通過：做多方向一致：28檔
  - Tradeable Second Leg path 未通過：型態與分數品質：28檔
  - Tradeable Second Leg path 未通過：進場確認：28檔
  - Tradeable Second Leg path 未通過：合法突破情境：28檔
  - Tradeable Second Leg path 未通過：突破跟隨：28檔
  - Tradeable Second Leg path 未通過：對手方被困：28檔
  - Tradeable Second Leg path 未通過：True Breakout 品質：28檔
  - Tradeable Second Leg path 未通過：可交易第二段：28檔
- Candidate Stage：
  - setup_observation：57
...
- Performance完成樣本：620；正式Direct Buy完成樣本：0。
- 被拒絕候選整體勝率：50.32%；T+5平均報酬：0.48%；MFE：5.17%；MAE：-4.46%。
