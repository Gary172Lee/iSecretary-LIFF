...
> 報告狀態：**完成**｜產生時間：2026-08-21 14:23:59（Asia/Taipei）
...
Swing Buy 20D：9 檔合格；依 Extension Momentum 作第二層排序，v4.0 Gate 不變。
Swing Buy 20D：候選池 9；正式 Buy Now 0。正式名單以現價 Forward Entry Edge 為準。
Deep Recovery 3M：1 檔候選；屬早期復甦觀察池，不是BuyNow。

## 2. 資料日期、版本、工具讀取結果、P0安全與歷史來源稽核

- 報告版本：`daily_after_market_report_v5_deep_recovery_3m`
- 產生時間：2026-08-21 14:23:59（Asia/Taipei）
- latest_indicators：2026-08-21 14:23:42
- gate_diagnostics：2026-08-21 14:23:52
- 資料為今日：是
- 策略與引擎版本相容：是
...
- 今日候選池：9；Buy Now：0；Wait Pullback：6；Reject：3。
**今日 Buy Now = 0 檔。寧可沒有標的，也不把已過度延伸的強勢股當成現在可追價。**
**Wait Pullback（股票可強，但現價不是好買點；不列正式買進）**
- 2887 台新金｜**Wait Pullback**：現價進場優勢 52.96；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 36.15；原因：forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 1402 遠東新｜**Wait Pullback**：現價進場優勢 46.50；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 28.60；原因：entry_quality_below_7、forward_entry_edge_score_below_80、forward_rr_below_1_8、traceable_headroom_below_12pct。
- 2408 南亞科｜**Wait Pullback**：現價進場優勢 44.37；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 494.50；原因：entry_quality_below_7、extension_from_sma20_above_12pct、forward_entry_edge_score_below_80、forward_rr_below_1_8。
- 3008 大立光｜**Wait Pullback**：現價進場優勢 44.17；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 4970.86；原因：current_price_far_above_pullback_reference、entry_quality_below_7、extension_from_sma20_above_12pct、five_day_runup_above_12pct。
- 3443 創意｜**Wait Pullback**：現價進場優勢 42.95；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 5120.00；原因：entry_quality_below_7、extension_from_sma20_above_12pct、forward_entry_edge_score_below_80、forward_rr_below_1_8。
- 3081 聯亞｜**Wait Pullback**：現價進場優勢 40.15；剩餘空間 10.0%；Forward RR 1.43；Pullback參考 2622.50；原因：entry_quality_below_7、extension_from_sma20_above_12pct、five_day_runup_above_12pct、forward_entry_edge_score_below_80。
...
- **3532 台勝科｜Deep Recovery 3M**：現價 342.50；3M最高收盤 523.00；距高點 -34.5%；回前高空間 +52.7%；自低點回升 +29.2%；Recovery WeakUp；延伸動能 64.0／Moderate；RS改善 10.8；量能 1.80x；候選分 74.20／RecoveryReady；題材 `semiconductor`；基本面/消息面：待ChatGPT排程即時健康審核。
...
- **2201 裕隆｜不可買**：階段 `bullish_setup_ready`；類型 `confirmed_breakout`；分數 76.25；RR 1.59；目標 7.68%；原因：P0 Shadow Mode：獨立掃描器兩條現行進場假設均已退役，待重新設計與正式驗證
- **3037 欣興｜不可買**：階段 `setup_observation`；類型 `tradeable_second_leg`；分數 68.44；RR 4.98；目標 31.31%；原因：P0 Shadow Mode：獨立掃描器兩條現行進場假設均已退役，待重新設計與正式驗證
...
- **1504 東元｜不可買**：階段 `setup_observation`；類型 `tradeable_second_leg`；分數 未載明；RR 24.03；目標 未載明；原因：Tradeable Second Leg path 未通過：做多方向一致 | Tradeable Second Leg path 未通過：型態與分數品質 | Tradeable Second Leg path 未通過：進場確認 | Tradeable Second Leg path 未通過：目標報酬至少 10% | Tradeable Second Leg path 未通過：合法突破情境 | Tradeable Second Leg path 未通過：突破跟隨 | Tradeable Second Leg path 未通過：對手方被困 | Tradeable Second Leg path 未通過：True Breakout 品質 | Tradeable Second Leg path 未通過：可交易第二段
- **2313 華通｜不可買**：階段 `setup_observation`；類型 `tradeable_second_leg`；分數 未載明；RR 3.56；目標 未載明；原因：Tradeable Second Leg path 未通過：做多方向一致 | Tradeable Second Leg path 未通過：型態與分數品質 | Tradeable Second Leg path 未通過：進場確認 | Tradeable Second Leg path 未通過：目標報酬至少 10% | Tradeable Second Leg path 未通過：合法突破情境 | Tradeable Second Leg path 未通過：突破跟隨 | Tradeable Second Leg path 未通過：對手方被困 | Tradeable Second Leg path 未通過：True Breakout 品質 | Tradeable Second Leg path 未通過：可交易第二段
...
- Performance完成樣本：274；正式Direct Buy完成樣本：0。
- 被拒絕候選整體勝率：44.16%；T+5平均報酬：-0.94%；MFE：4.50%；MAE：-5.50%。
